...
echo "=================================================="
echo " 📥 1. 正在從 GitHub 拉取最新代碼與 K8s 設定檔 (分支: ${CURRENT_BRANCH})"
echo "=================================================="
...
echo ""
echo "=================================================="
echo " 📊 5. 監控系統存取資訊 (Prometheus & Grafana)"
echo "=================================================="
echo "📈 Grafana 視覺化儀表板: http://localhost:3000"
echo "   - 預設帳號: admin"
echo "   - 預設密碼: admin"
echo "🔍 Prometheus 指標端點: http://localhost:8080/actuator/prometheus"
echo "--------------------------------------------------"
